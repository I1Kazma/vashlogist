let calculator__submit = document.querySelector("#calculator__submit");
let calculator__success = document.querySelector("#calculator__success");
let calculator__close = document.querySelector("#calculator__close");

let btn__yes = document.querySelector("#btn__yes");
let btn__no = document.querySelector("#btn__no");
let btn__wrapper = document.querySelector("#btn__wrapper");
let calculator__yes = document.querySelector("#calculator__yes");

btn__yes.onclick = function (event) {
    event.preventDefault();
    calculator__yes.classList.toggle("selected");
    btn__wrapper.classList.toggle("inactive");
};

calculator__submit.onclick = function (event) {
    event.preventDefault();
    calculator__success.classList.toggle("success");
};

calculator__close.onclick = () => {
    calculator__success.classList.remove("success");
};
...
function crear_select() {
    ...
    for (var e = 0; e < div_cont_select.length; e++) {
        ...
        document
            .querySelectorAll("[data-indx-select='" + e + "']  > .select__option ")[0]
